...
describe("updatePreferences", () => {
  ...
  describe("successful updates", () => {
    ...
    it("should update themeStyle preference", async () => {
      const mockSession = {
        user: { id: "user-123", name: "Test User", email: "test@example.com" },
        session: { id: "session-123" },
      };
      ...
      const result = await updatePreferences({ themeStyle: "bubblegum" });

      expect(result).toEqual({ success: true });
      expect(prisma.user.update).toHaveBeenCalledWith({
        where: { id: "user-123" },
        data: { themeStyle: "bubblegum" },
      });
    });
  ...
  describe("validation", () => {
    ...
    it("should reject invalid themeStyle", async () => {
      const mockSession = {
        user: { id: "user-123", name: "Test User", email: "test@example.com" },
        session: { id: "session-123" },
      };
      ...
      const result = await updatePreferences({ themeStyle: "invalid" as any });
